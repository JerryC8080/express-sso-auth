...
module.exports = function() {
   ...
   */
  function generateToken(user = utils.argRequired('user'), clientName) {
    let key;
    if (!clientName){
   ...
   */
  function setToken(res = utils.argRequired('res'), ssoToken = utils.argRequired('ssoToken')) {
   ...
   * @param res
   */
  function clearToken(res = utils.argRequired('res')) {
   ...
   * @returns {*}
   */
  function login(user = utils.argRequired('res'), clientName, callback) {
    let that = this;
    let res = that.res;
    let err = null, token;
    ...
    try{
      token = that.api.generateToken(user, clientName).ssoToken;
